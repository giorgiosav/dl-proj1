...
def select_best_hyper_base(chans, nb_hidden1, nb_hidden2, nb_hidden3,
                           ...
                           n_runs=10, epochs=25, verbose=False):
    device = get_device()
    best_acc = 0
    best_params = {"eta": 0, "chan1": 0, "chan2": 0, "chan3": 0, "nb_hidden1": 0, "nb_hidden2": 0}
                        ...
                        for h2 in nb_hidden2:
                            for h3 in nb_hidden3:
                                ...
                                for i in range(0, n_runs):
                                    ...
                                    train_basic_model(model, train_loader, criterion, epochs, eta, optim=optim,
                                                      momentum=momentum, nesterov=nesterov)
                                    acc = compute_accuracy_basic(model, test_loader)
                                    tot_acc += acc
                                    del model
